...
export const Newsletters = () => {
  return (
    <section className="new-letter bg-color-3">
        <div className="container">
            <div className="new-letter-inner style-2 flex bg-color-5">
                    ...
                    <div className="form-subcribe">
                        <form id="subscribe-form" action="#" method="GET" acceptCharset="utf-8"
                            ...
                            <button name="submit" type="submit" id="submit"
                                className="sc-button style letter style-2"><span>Sign Up</span> </button>
                        </form>
                    </div>
                </div>
            </div>
